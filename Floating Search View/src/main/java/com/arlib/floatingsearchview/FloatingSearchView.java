...
public class FloatingSearchView extends FrameLayout {
    ...
    private int mSuggestionProgressColor = -1;
    ...
    public void setSuggestionsProgressColor(int color) {
        mSuggestionProgressColor = color;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mSearchProgress.setIndeterminateTintList(ColorStateList.valueOf(mSuggestionProgressColor));
        } else {
            mSearchProgress.getIndeterminateDrawable().setColorFilter(mSuggestionProgressColor, android.graphics.PorterDuff.Mode.MULTIPLY);
        }
